...
RUN git clone https://github.com/macarrie/vidocq --branch v0.1 dep_vidocq && cd dep_vidocq && cargo build --release --target x86_64-unknown-linux-musl && ls -R && cp target/x86_64-unknown-linux-musl/release/vidocq ../
